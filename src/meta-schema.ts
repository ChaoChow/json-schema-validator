// Generated from https://json-schema.org/draft/2020-12/* — do not edit by hand.

/** The 2020-12 meta-schema and its vocabulary meta-schemas, keyed by `$id`. */
export const metaSchemaMap: Record<string, unknown> = {
